...
update public.menu_items set image_url = '/menu/garlic-bread.jpg' where name = 'Garlic Bread';
...
update public.menu_items set image_url = '/menu/butter-chicken.jpg' where name = 'Butter Chicken';
